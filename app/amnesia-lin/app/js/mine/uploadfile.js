...
function uploadfile(id){
    if(id =="datafile" || id =="setfile" || id=="xmlfile"){
        ...
        $.ajax({
            url: "http://localhost/action/getcolumnnames",
            type: "POST",
            success : function(result){
//                alert("Edddddvvv");
                if(result!=null){
...
function errorHandling(error){
    $.ajax({
        url: "http://localhost/action/errorhandle",
        type: "POST",
        data: "error="+error,
        success : function(result) {
...
function uploadfile2(id){
    ...
    if ( FLAG == true){
        if ( id =="datafile" || id =="setfile" || id=="xmlfile" ){
            ...
            $.ajax({
                dataType : "json",
                url : "http://localhost/action/upload",
                data : oMyForm,
                type : "POST",
                ...
                success : function(result) {
                    ...
                    if ( id == "datafile" || id == "xmlfile" ){
                        ...
                        $.ajax({
                            url: "http://localhost/action/getsetdata",
                            type: "POST",
                            success : function(result) {
                                if(!result.success){
                                    alert(result.problem);
...
//                        alert(result.problem);
                    ...
                    if (id == "anonrules"){
                        $.ajax({
                            url: "http://localhost/action/loadanonymizationrules",
                            type: "POST",
                        ...
                        $.ajax({
                            url: "http://localhost/action/loadhierarchy",
                            type: "POST",
                            data: { filename:file.name },
                            success : function(result) {
...
function getsmalldataset() {
    ...
    if ( del == ""){
        ...
        $("#spinner").show();
        $.ajax({
            url: "http://localhost/action/getsmalldataset",
            type: "POST",
...
function datahierexists(){
     $.ajax({
        url: "http://localhost/action/getdashboard",
        type: "POST",
        success : function(result) {
            var str;
        ...
        success : function(result) {
            if ( result != null){
                ...
                $('#dataset').DataTable({
                    ...
                    "ajax": {
                        "url": "http://localhost/action/getdataset",
                        "type": "POST",
                    },
...
function getexampledataset(){
    ...
    $.ajax({
        url: "http://localhost/action/getexampledataset",
        type: "POST",
        success : function(result) {
            var str =  "<thead>" +"<tr>" ;
...
function loaddataset(vartypes,checkColumns){
    ...
    if (vartypes != null ){
        ...
        $.ajax({
            url: "http://localhost/action/loaddataset",
            type: "POST",
...
//    console.log("edwwwwwwwwwwwwwwwwwwwww");
    $.ajax({
        url: "http://localhost/action/gethiergraph",
        type: "POST",
            ...
            var options = {
                ...
                manipulation: {
                    ...
                    deleteNode: function (data, callback) {
                        ...
                        $.ajax({
                            url: "http://localhost/action/deletenodehier",
                            type: "POST",
...
//                                    }
                        ...
                        if (toChild == "" || toChild== "(null)"){
                            ...
                            callback(data);
                            $.ajax({
                                url: "http://localhost/action/addnodehier",
                                type: "POST",
            ...
            function saveData(data,callback) {
                ...
                if ( action != "edit"){
                    ...
                    if ( node == ""){
                        ...
                        $.ajax({
                            url: "http://localhost/action/editnodehier",
                            type: "POST",
...
function getHierNames(){
    ...
    $.ajax({
        url: "http://localhost/action/gethierarchies",
        type: "POST",
...
function saveselectedhier(hiername){
    ...
    $.ajax({
        url: "http://localhost/action/saveselectedhier",
        type: "POST",
...
function removeHierarchy(){
    $.ajax({
        url: "http://localhost/action/removehierarchy",
        type: "POST",
        success : function(result){
            if(result === 'no'){
...
function getHierarchies(){
    ...
    $.ajax({
        url: "http://localhost/action/getselectedhier",
        type: "POST",
...
function getrelations(){
    ...
    $.ajax({
        url: "http://localhost/action/getattrtypes",
        type: "POST",
...
function algorithmExecution(){
    ...
    if (FLAG == "false"){
        ...
        $( "#spinner" ).show();
        $.ajax({
            url: "http://localhost/action/algorithmexecution",
            type: "POST",
...
function getsolutiongraph(){
    ...
    $.ajax({
        url: "http://localhost/action/getsolutiongraph",
        type: "GET",
        success : function(result) {
            var nodes = new vis.DataSet(result.nodeList);
            var edges = new vis.DataSet(result.edgeList);
            ...
            network.on('doubleClick', function (properties) {
                ...
                $.ajax({
                    url: "http://localhost/action/setselectednode",
                    type: "POST",
...
//                                console.log()
                                ...
                                var dataTable = $('#anondataset').DataTable({
                                   ...
                                   "ajax": {
                                       "dataSrc": "dataAnon",
                                       "url": "http://localhost/action/getanondataset",
                                       "type": "POST",
                                       "error": function (xhr, status, error) {
                                            if(xhr.hasOwnProperty('responseText')){
                                                console.log(xhr.responseText);
...
function saveDataset(){
    ...
    $.fileDownload('http://localhost/action/savedataset')
...
function saveHierarchy(){
    ...
    $.fileDownload('http://localhost/action/savehierarchy')
    .done(function () { alert('File download a success!'); })
    .fail(function () { alert('File download failed!'); }); 
}
...
function saveAnonymizeDataset(){
    ...
    $.fileDownload('http://localhost/action/saveanonymizedataset')
...
function getSimilarZenodoFiles(usertoken,filename,title,keywords){
    ...
    zenTable = $('#zenodosimilarfiles').DataTable( {
        ...
        "ajax": {
           "url": "http://localhost/action/getsimilarzenodofiles",
           "type": "POST",
           "data":{
...
function getZenodoFiles(usertoken){
   ...
   $("#spinner").show();
    ...
    var table = $('#zenodofiles').DataTable({
        ...
        "ajax": {
           "url": "http://localhost/action/getzenodofiles",
           "type": "POST",
           "data":{
                "usertoken":usertoken
            },
    ...
    $('#zenodofiles tbody').on('click', 'tr', function () {
        ...
        $.ajax({
            url: "http://localhost/action/loadzenodofile",
            type: "POST",
...
function saveFileToZenodo(usertoken, author, affiliation, filename , title, description, contributors, keywords){
    ...
    $.ajax({
        url: "http://localhost/action/savefiletozenodo",
        type: "POST",
...
function autogenerate(typehier,vartype,onattribute,step,sorting,hiername, fanout, limits, months, days, years,length){
    ...
    $.ajax({
        url: "http://localhost/action/autogeneratehierarchy",
        type: "POST",
...
function getStatistics(){
    ...
    $("#spinner").show();
    $.ajax({
        url: "http://localhost/action/findsolutionstatistics",
        type: "POST",
        success : function(result) {
            ...
            $.ajax({
                url: "http://localhost/action/getsolutionstatistics",
                type: "GET",
...
function getAttributesFromModal(){
    ...
    $.ajax({
        ...
        success : function(result) {
            ...
            $.ajax({
                url: "http://localhost/action/checkdataset",
                type: "POST",
                data:{attributes:selectedAttr},
                success : function(k) {
                    $.ajax({
                        url: "http://localhost/action/getsourcestatistics",
                        type: "GET",
...
function restart(){
    ...
    $.ajax({
        url: "http://localhost/action/restart",
        type: "POST",
        data :{},
        success : function(result) {
            window.location = "index.html";
...
function deleteSuppress(){
    ...
    $.ajax({
        url: "http://localhost/action/deletesuppress",
        type: "POST",
        data :{},
        success : function(result) {
...
function suppressValues(source){
    ...
    $.ajax({
        url: "http://localhost/action/suppress",
        type: "POST",
        data :{},
        success : function(result) {
            if ( source == 'true'){
...
function queriesStatistics(){
    ...
    $.ajax({
        url: "http://localhost/action/getcolumnnamesandtypes",
        type: "POST",
        success : function(result) {
...
function getProperAlgorithm(){
    ...
    $.ajax({
        url: "http://localhost/action/getproperalgorithm",
        type: "POST",
        success : function(result) {
            var str;
...
function getSetValuedColumn(){
    $.ajax({
        url: "http://localhost/action/getsetvaluedcolumn",
        type: "POST",
        success : function(result) {
...
function getBarData(identifiersArr,minArr,maxArr,distinctArr){
    $.ajax({
        url: "http://localhost/action/getresultsstatisticsqueries",
        type: "POST",
        cache: false,
        async: false,
...
function hierarchiesStatistics(){
    $.ajax({
        url: "http://localhost/action/gethiernamesandlevels",
        type: "POST",
        success : function(result) {
            console.log("result = " + result);
...
function deleteDataset(){
    ...
    $.ajax({
        url: "http://localhost/action/deletedataset",
        type: "POST",
        data :{},
        success : function(result) {
...
function deteleHierarchy(){
    ...
    window.location = "myhier.html";
//    $.ajax({
//        url: "http://localhost/action/deletehier",
//        type: "POST",
//        data :{},
//        success : function(result) {
//            window.location = "myhier.html";
...
function saveAnonumizationRules(){
    ...
    $.fileDownload('http://localhost/action/savenonymizationrules')
    .done(function () { alert('File download a success!'); })
    .fail(function () { alert('File download failed!'); });
}
...
function cleanUserData() {
    $.ajax({
        url: "http://localhost/action/cleanusedata",
        type: "POST",
        data :{},
        success : function(result) {
